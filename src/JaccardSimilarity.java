...
public class JaccardSimilarity {
    public static void main(String args[]) throws IOException {        Jaccard j=new Jaccard();
        FileTokenizer f1 = new FileTokenizer();
        f1.buildSources("C:\\Users\\Khaled Samir\\OneDrive\\Desktop\\Jaccard similarity\\src\\doc1.txt");

        FileTokenizer f2 = new FileTokenizer();
        f2.buildSources("C:\\Users\\Khaled Samir\\OneDrive\\Desktop\\Jaccard similarity\\src\\doc2.txt");
